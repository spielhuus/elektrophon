...
**elektrophon** is a collection of modular synthesizer modules i have built. The module folders contain the schema and PCB files for kicad. You can find all the required files for changing the schemas and building gerber files in the projects.  
