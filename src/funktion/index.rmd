...
draw.property("U[1..]", "Spice_Primitive", "X", 2); 
draw.property("U[1..]", "Spice_Model", "TL072c", 2); 
draw.property("Q[1..]", "Spice_Netlist_Enabled", "Y", 2); 
draw.property("Q1", "Spice_Primitive", "X", 2); 
draw.property("Q[2..]", "Spice_Primitive", "Q", 2); 
draw.property("Q1", "Spice_Model", "THAT340", 2); 
draw.property("Q[2..]", "Spice_Model", "BC556B", 2); 
draw.property("Q2", "Spice_Model", "BC846B", 2); 
draw.property("Q4", "Spice_Model", "BC846B", 2); 
draw.property("Q5", "Spice_Model", "BC846B", 2); 
draw.property("Q[8..9]", "Spice_Model", "BC846B", 2); 
draw.property("D[1..]", "Spice_Netlist_Enabled", "Y", 2); 
draw.property("D[1..]", "Spice_Primitive", "D", 2); 
draw.property("D[1..]", "Spice_Model", "D1N4148", 2); 
draw.property("D[1..]", "Spice_Node_Sequence", "2 1", 2); 
draw.property("J1", "Spice_Primitive", "J", 2); 
draw.property("J1", "Spice_Model", "J201", 2); 
draw.property("J1", "Spice_Node_Sequence", "1 3 2", 2); 
