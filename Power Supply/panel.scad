...
module panel_power(armatures=false) {
    ...
    translate([HP*HP_SIZE/2,20+6,1]) reflector(r1=4,r2=2,l=20,thickness=2,led=1.5,h=5,span=10);
    translate([HP*HP_SIZE/3-2,HU*HU_SIZE-90,0]) reflector(h=5,l=5,r1=5,r2=2,thickness=REFLECTOR_THICKNESS,led=1.5,span=14);
    translate([HP*HP_SIZE/3-2,HU*HU_SIZE-70,0]) reflector(h=5,l=5,r1=5,r2=2,thickness=REFLECTOR_THICKNESS,led=1.5,span=14);
    translate([HP*HP_SIZE/3-2,HU*HU_SIZE-50,0]) reflector(h=5,l=5,r1=5,r2=2,thickness=REFLECTOR_THICKNESS,led=1.5,span=14);
    translate([HP*HP_SIZE/3-2,HU*HU_SIZE-30,0]) reflector(h=5,l=5,r1=5,r2=2,thickness=REFLECTOR_THICKNESS,led=1.5,span=14);
}
