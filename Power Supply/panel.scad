...
module panel_power() {
    color("white") difference() {
        ...
        translate( [HP*HP_SIZE/2, 20+6+2.5, 0]) silkscreen( text="POWER" );
        translate( [HP*HP_SIZE/2, 20+6+70, 0]) silkscreen( text="+6V" );
        translate( [HP*HP_SIZE/2, 20+6+80, 0]) silkscreen( text="+6V" );
        translate( [HP*HP_SIZE/2, 20+6+100, 0]) silkscreen( text="+6V" );
