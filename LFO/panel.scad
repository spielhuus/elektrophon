...
module panel_vca(thickness=THICKNESS, screen=SCREEN, font_size=FONT_SIZE,armatures=ARMATURES) {
    difference() {
        ...
        translate([TOP_REFLECTOR_X, TOP_REFLECTOR_Y, 0]) rotate([0,0,270]) silkscreen(text="LFO1",thickness=thickness, screen=screen, font_size=font_size, font="Designer Block");
    ...
    if(armatures) {
        ...
        translate([2*RASTER_X+TOP_REFLECTOR_X, TOP_REFLECTOR_Y, 0]) rotate([0,0,270]) silkscreen_text (text="VCA2",thickness=thickness, screen=screen, font_size=font_size, font="Designer Block");
