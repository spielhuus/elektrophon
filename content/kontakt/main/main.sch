...
$EndDescr
$Sheet
S -2200 1200 1750 450 
U 5E9FE2D3
F0 "STM32 Board" 50
F1 "stm32_board.sch" 50
$EndSheet
$Sheet
S -2200 2250 1800 400 
U 5EAB1F13
...
OUT_CLOCK
Text GLabel -750 4400 2    50   Input ~ 0
LED_ACTIVITY
Text GLabel -750 4500 2    50   Input ~ 0
LED_CONNECT
$Comp
L power:GND #PWR018
U 1 1 5EAA851E
...
F 0 "#PWR018" H -2200 4200 50  0001 C CNN
F 1 "GND" V -2200 4250 50  0000 C CNN
...
F 0 "#PWR017" H -2200 4200 50  0001 C CNN
F 1 "+5V" V -2200 4550 50  0000 C CNN
...
U 1 1 5EA557A8
P -2400 5050
F 0 "J2" H -2508 5935 50  0000 C CNN
F 1 "Conn_01x15_Female" H -2508 5844 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x15_P2.54mm_Vertical" H -2400 5050 50  0001 C CNN
...
PA12
Text GLabel -750 4600 2    50   Input ~ 0
PA11
$Comp
L Device:CP C2
U 1 1 5EA70421
...
U 1 1 5EB82EA4
P -950 4500
F 0 "J3" H -1058 4785 50  0000 C CNN
F 1 "Conn_01x04_Female" H -1058 4694 50  0000 C CNN
...
$EndComp
$Comp
L esp32-wrover:ESP32-WROVER U12
U 1 1 5FF9545D
P 2150 2700
F 0 "U12" H 2125 4037 60  0000 C CNN
F 1 "ESP32-WROVER" H 2125 3931 60  0000 C CNN
